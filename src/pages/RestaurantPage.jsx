...
// Placeholder component for DataViewer
const DataViewer = () => (
    <div className="p-8 text-center">
        <h3 className="text-xl font-semibold text-gray-700 mb-4">Data Viewer</h3>
        <p className="text-gray-500">Data viewer functionality coming soon...</p>
    </div>
);
